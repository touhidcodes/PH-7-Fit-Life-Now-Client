...
const BannerSlider = ({ title, image }) => {
	return (
		<div className='grid grid-cols-1 lg:grid-cols-2 gap-10 px-10 py-5 lg:px-20 lg:py-10 items-center grid-col-reverse'>
			<div className='space-y-5 ml-5'>
				<h4 className='text-3xl lg:text-6xl font-semibold text-red-400'>
					{title}
				</h4>
